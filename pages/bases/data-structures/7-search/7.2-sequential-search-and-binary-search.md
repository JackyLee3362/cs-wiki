...
> [!info] 基础概念
> 相关提炼内容见 [[binary-search]] [[array-list]]。
...
二分查找：[Leecode 算法题：二分查找](https://leetcode.cn/problems/binary-search/)，题解见 [[binary-search]]
...
- [Leecode 算法题：二分查找](https://leetcode.cn/problems/binary-search/) #todo
